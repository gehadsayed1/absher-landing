...
const messages = {
  en: {
    ...
    typingServices:"Typing Services",
    home: "Home",
    copyrightText: "Copyright 2023, All rights reserved By.",
    ...
    message: "Message",
    address: "Deira, Dubai - Golden Business Center, Office 106",
    phone1: "+971 54 443 8239",
    phone2: "+971 50 185 7614",
    phone3: "+971 4 335 5739",
    emailAddress: "abisheirbelkhaier2@gmail.com",
    ...
    hero_description:
      "Your Trusted Partner for Travel Services. We simplify the process of handling all your travel-related transactions quickly and securely. Let us take care of the details while you focus on your journey with peace of mind.",
  },
...
success:"تم ارسال الرسالة بنجاح",
    ...
    subheading: "نبذة",
    copyrightText: "حقوق النشر 2023، جميع الحقوق محفوظة بواسطة.",
    column1Heading: "عننا ",
    ...
    listItem1: "هنا تعيش النصوص العمياء",
    listItem2: "بعيدًا جدًا خلف الكلمة",
    listItem3: "مكانهم ومواردهم",
    ...
    hero_description:
      "نحن هنا لجعل إجراءات السفر أكثر سهولة وسلاسة، حيث نوفر لك حلولًا متكاملة لإنجاز جميع معاملاتك بسرعة وأمان. اترك لنا التفاصيل واستمتع برحلتك بلا قلق!",
  },
};
